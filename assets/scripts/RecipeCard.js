...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		// EXPOSE - START
		// A1. Attach the shadow DOM to this Web Component
		this.attachShadow({ mode: 'open' });

		// A2.Create an <article> element
		this.article = document.createElement('article');

		// A3. Create a style element for the Web Component
  ...
  * {
  ...
  time {
	...
	set data(data) {
		...
		// A6. Select the <article> added to Shadow DOM in the constructor
